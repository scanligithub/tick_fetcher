...
def extract_auction_features(ticks_df: pl.DataFrame, prev_close: float) -> dict:
    ...
    if auction_df.is_empty():
        return {"auction_volume": 0.0, "auction_gap": 0.0, "auction_strength": 0.0, "auction_stability": 1.0}
    ...
    return {
        "auction_volume": auction_volume, "auction_gap": auction_gap,
        "auction_strength": auction_strength, "auction_stability": auction_stability
    }
